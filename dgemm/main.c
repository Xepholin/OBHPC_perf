...
int main(int argc, char **argv)
{
  ...
  run_benchmark("IJK",   dgemm_ijk, n, r, a, b, c);
  run_benchmark("IKJ",   dgemm_ikj, n, r, a, b, c);
  run_benchmark("IEX",   dgemm_iex, n, r, a, b, c);
  run_benchmark("UNROLL4", dgemm_unroll4, n, r, a, b, c);
  run_benchmark("UNROLL8", dgemm_unroll8, n, r, a, b, c);
  run_benchmark("CBLAS", dgemm_cblas, n, r, a, b, c);
