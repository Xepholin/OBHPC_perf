...
int main(int argc, char **argv)
{
  ...
  run_benchmark("BASE",   reduc_base, n, r, a);
  run_benchmark("UNROLL4",   reduc_unroll4, n, r, a);
  run_benchmark("UNROLL8",   reduc_unroll8, n, r, a);
  run_benchmark("CBLAS",   reduc_cblas, n, r, a);
