...
int main(int argc, char **argv)
{
  ...
  run_benchmark("BASE",   dotprod_base, n, r, a, b);
  run_benchmark("UNROLL4",   dotprod_unroll4, n, r, a, b);
  run_benchmark("UNROLL8",   dotprod_unroll8, n, r, a, b);
  run_benchmark("CBLAS",   dotprod_cblas, n, r, a, b);
